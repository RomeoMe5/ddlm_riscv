# DDLM: Digital Design Lab Manual RISC-V
...
![Плата Terasic De10-lite](https://github.com/RomeoMe5/ddlm_riscv/blob/master/img/de10-lite.png)      
...
![Структура репозитария](https://github.com/RomeoMe5/ddlm_riscv/blob/master/img/repo_tree.png)       
Каждая папка соответствует определенной практической работе и может содержать поддиректории doc, pkg, img, **src**.         
![Внутри каждой папки](https://github.com/RomeoMe5/ddlm_riscv/blob/master/img/repo_dir.png)      
...
![Внутри папки главы](https://github.com/RomeoMe5/ddlm_riscv/blob/master/img/repo_lab4_tree.png)      
Каждый пример содержит файл верхнего уровня иерархии        
![Файл верхнего уровня иерархии](https://github.com/RomeoMe5/ddlm_riscv/blob/master/img/repo_lab4_top_level_entity.png)       
...
![Дополнительные задания](https://github.com/RomeoMe5/ddlm_riscv/blob/master/img/repo_dop_zad.png)
